...
try:
    ...
    pass
root.title("Drawplot English")  # Set the window title
...
# Create guide labels
guide_label_1 = Label(root, text="FN List : u(t) - r(t) - sin(t, omega) - cos(t, omega) - delta(t) | s(t) - exp_decay(t, alpha) | e_1(t, alpha) - exp(t, alpha) | e(t, alpha)", anchor='e', justify=RIGHT)
guide_label_2 = Label(root, text="Example : u(t) - r(t-1) + 2*delta(t-2)", anchor='e', justify=LEFT)
...
t_start_label = Label(root, text="Start Diagram :")
...
t_end_label = Label(root, text="Ends at :")
...
btn = Button(root, text="Draw ...", command=show_plot, width=30)
